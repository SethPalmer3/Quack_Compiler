...
void assert_is_type(obj_ref thing, class_ref expected) {
  ...
  fprintf(stderr, "Type check failure:%s is not subclass of %s\n",
          thing_class->header.class_name, expected->header.class_name);
  assert(0);
}
 ...
 */
vm_Word method_tbd_0[] = {{.instr = vm_op_enter},
                          {.instr = vm_op_call_native},
                          {.native = native_tbd},
                          {.instr = vm_op_return},
                          {.intval = 0}};

vm_Word method_tbd_1[] = {{.instr = vm_op_enter},
                          {.instr = vm_op_call_native},
                          {.native = native_tbd},
                          {.instr = vm_op_return},
                          {.intval = 1}};

vm_Word method_tbd_2[] = {{.instr = vm_op_enter},
                          {.instr = vm_op_call_native},
                          {.native = native_tbd},
                          {.instr = vm_op_return},
                          {.intval = 2}};
...
vm_Word method_Obj_constructor[] = {{.instr = vm_op_enter},
...
vm_Word method_Obj_string[] = {{.instr = vm_op_enter},
                               {.instr = vm_op_call_native},
...
vm_Word method_Obj_print[] = {
    {.instr = vm_op_enter},      {.instr = vm_op_load}, {.intval = 0},
    {.instr = vm_op_methodcall}, {.intval = 1}, // string method
    {.instr = vm_op_methodcall}, {.intval = 2}, // print method of class string
    {.instr = vm_op_return},     {.intval = 0}};
...
vm_Word method_String_constructor[] = {{.instr = vm_op_enter},
                                       {.instr = vm_op_call_native},
...
vm_Word method_String_string[] = {{.instr = vm_op_enter},
                                  {.instr = vm_op_load},
...
vm_Word method_String_print[] = {{.instr = vm_op_enter},
                                 {.instr = vm_op_call_native},
...
vm_Word method_Boolean_constructor[] = {{.instr = vm_op_enter},
                                        {.instr = vm_op_call_native},
...
vm_Word method_Boolean_string[] = {{.instr = vm_op_enter},
                                   {.instr = vm_op_call_native},
 ...
 * them.
 */
struct obj_Boolean_struct lit_false_struct = {.header.clazz =
                                                  &the_class_Boolean_struct,
                                              .header.tag = GOOD_OBJ_TAG,
                                              .value = 0};

obj_ref lit_false = (obj_ref)&lit_false_struct;

struct obj_Boolean_struct lit_true_struct = {.header.clazz =
                                                 &the_class_Boolean_struct,
                                             .header.tag = GOOD_OBJ_TAG,
                                             .value = -1};
...
vm_Word method_Nothing_constructor[] = {{.instr = vm_op_enter},
                                        {.instr = vm_op_call_native},
...
vm_Word method_Nothing_string[] = {{.instr = vm_op_enter},
                                   {.instr = vm_op_call_native},
...
static struct obj_Nothing_struct nothing_struct = {
    .header.clazz = &the_class_Nothing_struct, .header.tag = GOOD_OBJ_TAG};
...
vm_Word method_int_constructor[] = {{.instr = vm_op_enter},
                                    {.instr = vm_op_call_native},
...
vm_Word method_Int_string[] = {{.instr = vm_op_enter},
                               {.instr = vm_op_call_native},
...
obj_ref native_Int_equals(void) {
  ...
  log_debug("Comparing integer values for equality: %d == %d", this_int->value,
            other_int->value);
...
vm_Word method_Int_equals[] = {{.instr = vm_op_enter},
                               {.instr = vm_op_call_native},
...
vm_Word method_Int_less[] = {{.instr = vm_op_enter},
                             {.instr = vm_op_call_native},
...
obj_ref native_Int_plus(void) {
  ...
  assert_is_type(other, the_class_Int);
  obj_Int other_int = (obj_Int)other;
  log_debug("Adding integer values: %d + %d", this_int->value,
            other_int->value);
  obj_ref sum = new_int(this_int->value + other_int->value);
  return sum;
}

vm_Word method_Int_plus[] = {{.instr = vm_op_enter},
                             {.instr = vm_op_call_native},
...
obj_ref native_Int_minus(void) {
  ...
  assert_is_type(other, the_class_Int);
  obj_Int other_int = (obj_Int)other;
  log_debug("Subtracting integer values: %d - %d", this_int->value,
            other_int->value);
  obj_ref sum = new_int(this_int->value - other_int->value);
  return sum;
}

vm_Word method_Int_minus[] = {{.instr = vm_op_enter},
                              {.instr = vm_op_call_native},
...
obj_ref native_Int_times(void) {
  ...
  assert_is_type(other, the_class_Int);
  obj_Int other_int = (obj_Int)other;
  log_debug("Multiplying integer values: %d * %d", this_int->value,
            other_int->value);
  obj_ref sum = new_int(this_int->value * other_int->value);
  return sum;
}

vm_Word method_Int_times[] = {{.instr = vm_op_enter},
                              {.instr = vm_op_call_native},
...
vm_Word method_Int_divide[] = {{.instr = vm_op_enter},
                               {.instr = vm_op_call_native},
